...
trait RepoSupport extends Tables {
  ...
  class UserRepo extends AbstractRepo[JdbcProfile, User, UserTable](config, users)
  class AccountRepo extends AbstractRepo[JdbcProfile, Account, AccountTable](config, accounts)
  class ProductRepo extends AbstractRepo[JdbcProfile, Product, ProductTable](config, products)
